...
DEFAULT_ASSIGNEE = "<assignee-email>"          # ← EDITAR al inicio: email del asignado (ej. dev@playbypoint.com)
                                               # Preferir email; también acepta display name o accountid:…
